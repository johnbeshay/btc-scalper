...
class TestTimeOfDayVol(unittest.TestCase):
    ...
    def test_multiplier_is_clamped_both_ways(self):
        ...
        for hour in (0, 5):
            ...
            self.assertGreaterEqual(a.vol_multiplier, 0.7)
            self.assertLessEqual(a.vol_multiplier, 1.4)
...
class TestVolUncertainty(unittest.TestCase):
    ...
    def test_disagreement_widens(self):
    ...
    def test_widening_is_capped(self):
        ...
        self.assertLessEqual(a.vol_multiplier, 1.5)
